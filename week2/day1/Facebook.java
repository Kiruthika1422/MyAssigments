...
public class Facebook {
	...
	public void credentials() {
		...
		driver.findElement(By.name("reg_email__")).sendKeys("kiruthikaarjunan2000@gmail.com");
		driver.findElement(By.name("reg_email_confirmation__")).sendKeys("kiruthikaarjunan2000@gmail.com");
		driver.findElement(By.id("password_step_input")).sendKeys("142203");
	}
	public void dob() {
		//day
